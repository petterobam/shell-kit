...
@Suite
struct ShellKitTestSuite {

    @Test
    func simpleOutput() throws {
    ...
    //
    //            Issue.record("This command should throw a `Shell.Error.generic(Int, String)` error.")
    //        }
    ...
    //                #expect(code == 0, "Exit code should not be zero.")
    //            case .outputData:
